...
const hola = axios.get('https://mn9ggcdjml.execute-api.us-east-2.amazonaws.com/prod/data/cc').then(async (response) => {
  ...
  <div class="w-full">
    <div class="flex gap-2 items-center py-4">
      <Input
        ...
        :model-value="table.getColumn('number')?.getFilterValue() as string"
        @update:model-value="table.getColumn('number')?.setFilterValue($event)"
      />
      <DropdownMenu>
